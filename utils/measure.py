...
"""
Import from https://github.com/ShichenLiu/CondenseNet/blob/master/utils.py
"""

__all__ = ['measure_model', 'weight_filler']
...
def measure_layer(layer, x):
    ...
    ### ops_nothing
    elif type_name in ['BatchNorm2d', 'Dropout2d', 'DropChannel', 'Dropout', 'Sequential', 'upsample_bilinear']:
        delta_params = get_layer_param(layer)
    ...
    # print type_name, delta_ops, delta_params
    return
